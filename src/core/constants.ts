...
export const FUND_TRANSFER_HOOK_ADDRESSES: Record<number, string> = {
  ...
  [SOLANA_DEVNET_CHAIN_ID]: "2ceSoYX1Q1C7gZwMFfdrfN9dKVbW4J2GiaUwRmf1qhVb",
...
export const MULTI_HOOK_ROUTER_ADDRESSES: Record<number, string> = {
  ...
  [SOLANA_DEVNET_CHAIN_ID]: "Cf6W2cLWW25TfhFhgSZAo2ZAchracAtJF1VM8N3C4yor",
...
export const SUBSCRIPTION_HOOK_ADDRESSES: Record<number, string> = {
  ...
  [SOLANA_DEVNET_CHAIN_ID]: "CG2kdS2S6FxRxEJ7MaxdbbPmACVYimdV7UvqjCP793gB",
