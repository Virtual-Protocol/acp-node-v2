...
// ---------------------------------------------------------------------------
// Solana seller — same lifecycle as src/examples/basic/seller.ts, but the
// agent is backed by a Solana client (`solanaProvider`) instead of an EVM one.
//
...
//     it has its own address/id, hence the SOLANA_SELLER_* env vars.
//
